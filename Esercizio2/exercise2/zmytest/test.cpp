...
bool TestCompareBSTMove(){
  ...
  if(!(BST1.Empty())){
    result=false;
    cout<<"Il move constructor di BST non ha cancellato right"<<endl;
  }
  ...
  if(!(BST2.Empty())){
    result=false;
    cout<<"L'operatore di assegnazione move di BST non ha cancellato right"<<endl;
  }
...
bool TestCompareEmptyBTAndBST(){
  ...
  if(!(move_BST2.Empty())){
    result=false;
    cout<<"L'assegnazione con move di BST non ha cancellato right"<<endl;
  }
  ...
  if(!(move_BT1.Empty())){
    result=false;
    cout<<"Il move constructor di BT non ha cancellato right"<<endl;
  }
  if(!(move_BT2.Empty())){
    result=false;
    cout<<"L'assegnazione con move di BT non ha cancellato right"<<endl;
  }
